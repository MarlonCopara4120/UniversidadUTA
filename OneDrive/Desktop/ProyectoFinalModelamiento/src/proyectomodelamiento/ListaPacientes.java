...
public class ListaPacientes {
    ...
    public Object buscar(String cedula){
        ...
        while(actual != null){
            if(((Paciente)(actual.dato)).cedula.equals(cedula)){
                return actual.dato;
            }
    ...
    // no hay lista donde buscar un paciente
 public Object buscarPaciente(String cedula){
        NodoDE actual = this.primero;
        if(actual == null){
            System.out.println("No hay ningun paciente creado");
            return null;
        }
        while(actual != null){
            if(((Paciente)(actual.dato)).cedula.equals(cedula)){
        ...
        if(((Paciente)(actual.dato)).cedula != cedula){
    ...
    public boolean borrarPorCedula(String cedula) {
        boolean borrado = false;
        while (this.primero != null && ((Paciente) (this.primero.dato)).cedula.equals(cedula)) {
            this.primero = this.primero.siguiente;
            if (this.primero != null) {
                this.primero.anterior = null;
            }
        ...
        if (this.primero != null) {
            NodoDE aux = this.primero;
            while (aux.siguiente != null) {
                if (((Paciente) (aux.siguiente.dato)).cedula.equals(cedula)) { //(aux.siguiente.dato == dato)
                    aux.siguiente = aux.siguiente.siguiente;
                    if (aux.siguiente != null) {
                        aux.siguiente.anterior = aux;
                    }
