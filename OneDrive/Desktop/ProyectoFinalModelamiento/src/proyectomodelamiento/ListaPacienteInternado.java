 ...
 * @author denni
 */
public class ListaPacienteInternado {
    NodoDE primero;

    public ListaPacienteInternado() {
        this.primero = null;
    }
    ...
    public Object buscarPacienteInternado(String cedula){
        NodoDE actual = this.primero;
        if(actual == null){           
            return null;
        }
        while(actual != null){
            if(((PacienteInternado)(actual.dato)).codigo.equals(cedula)){
                return actual.dato;
            }
